...
pytest.importorskip("numpy", reason="requires the autourgos-memory[vector] extra")

from autourgos_memory import Document, VectorMemory, VectorMemoryError, VectorRetriever
